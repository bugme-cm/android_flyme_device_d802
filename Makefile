...
vendor_saved_apps := Bluetooth KeyChain HTMLViewer UserDictionaryProvider BackupRestoreConfirmation \
                     ...
                     ProxyHandler Shell DefaultContainerService CMSettingsProvider NfcNci BluetoothExt \
                     TimeService CMSettings
...
#-----------------------------------------------------------------------------
board_remove_apps := LogReport Search Reader
...
override_property += \
    ...
    ro.product.model_romer=D802_moonlight
